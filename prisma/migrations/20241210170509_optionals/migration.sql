...
-- AlterTable
ALTER TABLE "Channel" ADD COLUMN     "boardId" TEXT;
...
-- AddForeignKey
ALTER TABLE "Channel" ADD CONSTRAINT "Channel_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "Board"("id") ON DELETE SET NULL ON UPDATE CASCADE;
